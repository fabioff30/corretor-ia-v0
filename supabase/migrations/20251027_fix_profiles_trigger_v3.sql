-- Migration: Fix Profiles Table and Auto-Creation Trigger (v3 - SIMPLIFIED)
-- Created: 2025-10-27
-- Description:
...
RAISE NOTICE 'Trigger update_profiles_updated_at created';
...
RAISE NOTICE 'Function get_user_with_subscription updated';
