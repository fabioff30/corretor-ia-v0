...
import { faqData } from "@/components/rewrite/faq-data"
...
import { testimonials } from "@/components/rewrite/testimonials-data"
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="shadow-2xl border-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur">
              <CardContent className="p-0">
                <TextCorrectionForm initialMode="rewrite" defaultRewriteStyle="humanized" enableCrossNavigation={true} />
              </CardContent>
            </Card>
          </div>
        </section>
